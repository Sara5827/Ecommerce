...
@endif
    <img class="mr-3" src="https://www.pngitem.com/pimgs/m/421-4212341_default-avatar-svg-hd-png-download.png" width="80px" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
